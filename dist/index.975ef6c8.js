...
var _flipCard = require("./js/flipCard");
var _flipCardDefault = parcelHelpers.interopDefault(_flipCard);
var _shuffleCards = require("./js/shuffleCards");
...
parcelHelpers.export(exports, "secondSelectedCard", ()=>secondSelectedCard);
parcelHelpers.export(exports, "flipCards", ()=>flipCards);
parcelHelpers.export(exports, "default", ()=>flipCard);
var _isMatchesCards = require("./isMatchesCards");
var _isMatchesCardsDefault = parcelHelpers.interopDefault(_isMatchesCards);
var _countMoves = require("./countMoves");
var _countMovesDefault = parcelHelpers.interopDefault(_countMoves);
...
function flipCards() {
    ...
    isCardFlipped = false;
    (0, _isMatchesCardsDefault.default)();
    (0, _countMovesDefault.default)();
}
function flipCard() {
...
parcelHelpers.export(exports, "default", ()=>checkForMatch);
var _flipCard = require("./flipCard");
var _flipCardDefault = parcelHelpers.interopDefault(_flipCard);
var _findedAllPairs = require("./findedAllPairs");
var _findedAllPairsDefault = parcelHelpers.interopDefault(_findedAllPairs);
var _disableClickListener = require("./disableClickListener");
var _disableClickListenerDefault = parcelHelpers.interopDefault(_disableClickListener);
let findedPairs = [];
function checkForMatch() {
    if ((0, _flipCard.firstSelectedCard).getAttribute("data-id") === (0, _flipCard.secondSelectedCard).getAttribute("data-id")) {
        findedPairs.push([
            (0, _flipCard.firstSelectedCard),
            (0, _flipCard.secondSelectedCard)
        ]);
        (0, _disableClickListenerDefault.default)();
        (0, _findedAllPairsDefault.default)();
        return;
    }
    setTimeout(()=>{
        (0, _flipCard.firstSelectedCard).classList.remove("is-flipped");
        (0, _flipCard.secondSelectedCard).classList.remove("is-flipped");
    }, "800");
}
...
var _isMatchesCards = require("./isMatchesCards");
var _openFinishModal = require("./openFinishModal");
var _openFinishModalDefault = parcelHelpers.interopDefault(_openFinishModal);
function getFindedPairs() {
...
function disableClickListener() {
    (0, _flipCard.firstSelectedCard).setAttribute("style", "pointer-events: none");
    (0, _flipCard.secondSelectedCard).setAttribute("style", "pointer-events: none");
}
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>restart);
function restart() {
